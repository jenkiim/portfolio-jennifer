...
![Screenshot of app Checkmate that shows how compatible the user's friends are with each other](./../assets/images/checkmate.jpg){:width="300"}
...
![Screenshot of Twitter/X Space where people can host pannel talks live.](./../assets/images/spaces.jpg){:width="300"}
